...
login_managaer = LoginManager()
login_managaer.init_app(app)
login_managaer.login_view== 'login'  # Login View for redirection

@login_managaer.user_loader
...
def register():
    ...
    if form.validate_on_submit():
        flash('Registration Succesfull', 'success') #success as the category
